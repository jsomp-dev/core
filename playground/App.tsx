      ...
      <nav style={{
        ...
        <button
          ...
          style={{
            padding: '0.4rem 1rem',
            borderRadius: '0.25rem',
            background: currentTab === 'actions' ? '#27272a' : 'transparent',
            border: 'none',
            color: currentTab === 'actions' ? '#fafafa' : '#a1a1aa',
            cursor: 'pointer',
            fontWeight: '500',
            fontSize: '0.875rem',
            transition: 'all 0.2s'
        ...
        <button
          onClick={() => setCurrentTab('adapters')}
          style={{
            padding: '0.4rem 1rem',
            borderRadius: '0.25rem',
            background: currentTab === 'adapters' ? '#27272a' : 'transparent',
            border: 'none',
            color: currentTab === 'adapters' ? '#fafafa' : '#a1a1aa',
            cursor: 'pointer',
            fontWeight: '500',
            fontSize: '0.875rem',
            transition: 'all 0.2s'
        ...
        <button
          ...
          style={{
            padding: '0.4rem 1rem',
            borderRadius: '0.25rem',
            background: currentTab === 'hooks' ? '#27272a' : 'transparent',
            border: 'none',
            color: currentTab === 'hooks' ? '#fafafa' : '#a1a1aa',
            cursor: 'pointer',
            fontWeight: '500',
            fontSize: '0.875rem',
            transition: 'all 0.2s'
        ...
        <button
          onClick={() => setCurrentTab('bug')}
          style={{
            padding: '0.4rem 1rem',
            borderRadius: '0.25rem',
            background: currentTab === 'bug' ? '#27272a' : 'transparent',
            border: 'none',
            color: currentTab === 'bug' ? '#fafafa' : '#a1a1aa',
            cursor: 'pointer',
            fontWeight: '500',
            fontSize: '0.875rem',
            transition: 'all 0.2s'
        ...
        <button
          onClick={() => setCurrentTab('mounted')}
          style={{
            padding: '0.4rem 1rem',
            borderRadius: '0.25rem',
            background: currentTab === 'mounted' ? '#27272a' : 'transparent',
            border: 'none',
            color: currentTab === 'mounted' ? '#fafafa' : '#a1a1aa',
            cursor: 'pointer',
            fontWeight: '500',
            fontSize: '0.875rem',
            transition: 'all 0.2s'
